...
- повторяющейся последовательностью (`$( ... )`), используя `,` в качестве разделителя, 
...
работало как сдвигающееся окно, в котором видны только последние (в данном
...
реализуется синтаксис под-скрипта) *также* параметризирована временем жизни для 
...
> **Пояснение**: Я *сделал* этот раздел таким, каким он должен быть. В общем, он
